...
if opt.dataset == 'diginetica':
    dataset = 'diginetica_data/train-item-views.csv'
...
print(f'number of unique item id at the read and grouping = {number_of_unique_ids}')
...
print(f'number of session after data filtering = {number_of_session}')
...
if opt.dataset == 'diginetica':
    if not os.path.exists('datasets/diginetica'):
        os.makedirs('datasets/diginetica')
...
elif opt.dataset == 'datasets/yoochoose':
    if not os.path.exists('datasets/yoochoose1_4'):
        os.makedirs('datasets/yoochoose1_4')
    if not os.path.exists('datasets/yoochoose_64'):
        os.makedirs('datasets/yoochoose_64')
    pickle.dump(tes, open('datasets/yoochoose1_4/test.txt', 'wb'))
    pickle.dump(tes, open('datasets/yoochoose_64/test.txt', 'wb'))
    ...
    pickle.dump(tra4, open('datasets/yoochoose1_4/train.txt', 'wb'))
    pickle.dump(seq4, open('datasets/yoochoose1_4/all_train_seq.txt', 'wb'))

    pickle.dump(tra64, open('datasets/yoochoose_64/train.txt', 'wb'))
    pickle.dump(seq64, open('datasets/yoochoose_64/all_train_seq.txt', 'wb'))

else:
    if not os.path.exists('datasets/sample'):
        os.makedirs('datasets/sample')
    pickle.dump(tra, open('datasets/sample/train.txt', 'wb'))
    pickle.dump(tes, open('datasets/sample/test.txt', 'wb'))
    pickle.dump(tra_seqs, open('datasets/sample/all_train_seq.txt', 'wb'))
